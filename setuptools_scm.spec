...
Source0  : https://files.pythonhosted.org/packages/56/c9/09f4a531720b1bf54f316fdff926fbb937c59a9c4a34e3a533b26e501898/setuptools_scm-5.0.2.tar.gz
...
%prep
%setup -q -n setuptools_scm-5.0.2
cd %{_builddir}/setuptools_scm-5.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614961742
...
cp %{_builddir}/setuptools_scm-5.0.2/LICENSE %{buildroot}/usr/share/package-licenses/setuptools_scm/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
