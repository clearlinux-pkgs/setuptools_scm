...
%prep
%setup -q -n setuptools_scm-3.4.3
cd %{_builddir}/setuptools_scm-3.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579802150
...
cp %{_builddir}/setuptools_scm-3.4.3/LICENSE %{buildroot}/usr/share/package-licenses/setuptools_scm/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
