...
Version  : 6.0.0
Release  : 92
URL      : https://files.pythonhosted.org/packages/bf/b1/e647ab0ad77ad74fde7f088cfa796b6b8ff24d4e2d4fa5a0d924fdbd9c6b/setuptools_scm-6.0.0.tar.gz
...
%prep
%setup -q -n setuptools_scm-6.0.0
cd %{_builddir}/setuptools_scm-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615994473
...
cp %{_builddir}/setuptools_scm-6.0.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools_scm/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
