...
Source0  : https://files.pythonhosted.org/packages/e2/22/3c318bc7123014e032cd4c2ae90e030a5c9f864cd733aca0c991da2c978b/setuptools_scm-4.1.1.tar.gz
...
%prep
%setup -q -n setuptools_scm-4.1.1
cd %{_builddir}/setuptools_scm-4.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590535409
...
cp %{_builddir}/setuptools_scm-4.1.1/LICENSE %{buildroot}/usr/share/package-licenses/setuptools_scm/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
