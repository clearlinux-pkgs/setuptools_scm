...
Source0  : https://files.pythonhosted.org/packages/e0/e4/92594bcbc7c06b1afba1543d4fcdbf71b4d4d7b2e18c512725fbc1ac0a8c/setuptools_scm-3.4.2.tar.gz
...
%prep
%setup -q -n setuptools_scm-3.4.2
cd %{_builddir}/setuptools_scm-3.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579630546
...
cp %{_builddir}/setuptools_scm-3.4.2/LICENSE %{buildroot}/usr/share/package-licenses/setuptools_scm/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
