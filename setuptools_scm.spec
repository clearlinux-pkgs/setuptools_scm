...
Version  : 4.1.0
Release  : 80
URL      : https://files.pythonhosted.org/packages/50/37/645b31589ab702c212aba7fc85f9546120389175aa8e9bca5b012dd486da/setuptools_scm-4.1.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/50/37/645b31589ab702c212aba7fc85f9546120389175aa8e9bca5b012dd486da/setuptools_scm-4.1.0.tar.gz
...
%prep
%setup -q -n setuptools_scm-4.1.0
cd %{_builddir}/setuptools_scm-4.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590519789
...
cp %{_builddir}/setuptools_scm-4.1.0/LICENSE %{buildroot}/usr/share/package-licenses/setuptools_scm/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
